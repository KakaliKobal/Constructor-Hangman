...
var hangman = {
  wordBank: ["HOME", "VACATION", "PALM", "COCONUT", "AIRPLANE", "TRAVEL", "CARRIBEAN REEF", "SHARK", "HOTEL", "OCEAN", "GRAY REEF", "GREAT HAMMERHEAD", "GREAT WHITE", "GREENLAND", "LEMON", "LEOPARD", "DESSERT", "MEGALADON", "CLERK", "VIEW", "BEACH", "SCALLOPED HAMMERHEAD", "SEAGUL", "JELLYFISH", "SANDY", "JUNGLE", "FOREST", "TIGER", "WHALE", "WHITETIP REEF", "ZEBRA"],
  guessesRemaining: 10,
  ...
  newGame: function() {
    if(this.guessesRemaining === 10) {
      console.log("Try to guess the correct letters!");
      console.log("~~~~~~~~~~~~~~~~~~");
